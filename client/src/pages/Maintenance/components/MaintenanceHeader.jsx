    ...
    >
      <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-800">Maintenance Registry</h1>
          <p className="mt-1.5 max-w-2xl text-xs text-slate-450 leading-relaxed font-semibold">
            Schedule vehicle checks and monitor operational maintenance logs.
          </p>
        </div>
        <button
          onClick={onSchedule}
